...
export const QuickTimeIntervalTranslationMap = new Map<QuickTimeInterval, string>([
  ...
  [QuickTimeInterval.DAY_BEFORE_YESTERDAY, 'timeinterval.predefined.two-days-ago'],
  [QuickTimeInterval.THIS_DAY_LAST_WEEK, 'timeinterval.predefined.same-day-last-week'],
  [QuickTimeInterval.PREVIOUS_WEEK, 'timeinterval.predefined.last-week-sun-sat'],
  [QuickTimeInterval.PREVIOUS_WEEK_ISO, 'timeinterval.predefined.last-week-mon-sun'],
  [QuickTimeInterval.PREVIOUS_MONTH, 'timeinterval.predefined.last-month'],
  [QuickTimeInterval.PREVIOUS_QUARTER, 'timeinterval.predefined.last-quarter'],
  [QuickTimeInterval.PREVIOUS_HALF_YEAR, 'timeinterval.predefined.last-half-year'],
  [QuickTimeInterval.PREVIOUS_YEAR, 'timeinterval.predefined.last-year'],
  [QuickTimeInterval.CURRENT_HOUR, 'timeinterval.predefined.current-hour'],
  [QuickTimeInterval.CURRENT_DAY, 'timeinterval.predefined.today'],
  [QuickTimeInterval.CURRENT_DAY_SO_FAR, 'timeinterval.predefined.today-so-far'],
  [QuickTimeInterval.CURRENT_WEEK, 'timeinterval.predefined.this-week-sun-sat'],
  [QuickTimeInterval.CURRENT_WEEK_ISO, 'timeinterval.predefined.this-week-mon-sun'],
  [QuickTimeInterval.CURRENT_WEEK_SO_FAR, 'timeinterval.predefined.this-week-sun-sat-so-far'],
  [QuickTimeInterval.CURRENT_WEEK_ISO_SO_FAR, 'timeinterval.predefined.this-week-mon-sun-so-far'],
  [QuickTimeInterval.CURRENT_MONTH, 'timeinterval.predefined.this-month'],
  [QuickTimeInterval.CURRENT_MONTH_SO_FAR, 'timeinterval.predefined.this-month-so-far'],
  [QuickTimeInterval.CURRENT_QUARTER, 'timeinterval.predefined.this-quarter'],
  [QuickTimeInterval.CURRENT_QUARTER_SO_FAR, 'timeinterval.predefined.this-quarter-so-far'],
  [QuickTimeInterval.CURRENT_HALF_YEAR, 'timeinterval.predefined.this-half-year'],
  [QuickTimeInterval.CURRENT_HALF_YEAR_SO_FAR, 'timeinterval.predefined.this-half-year-so-far'],
  [QuickTimeInterval.CURRENT_YEAR, 'timeinterval.predefined.this-year'],
  [QuickTimeInterval.CURRENT_YEAR_SO_FAR, 'timeinterval.predefined.this-year-so-far']
